...
const Cart = () => {
  ...
  const stripePromise = loadStripe('pk_test_51M70IhEXYiWOfD9fhv0HWxXBOEZ9BqfIvOZd00XvJKbXDRcjUhduY6JePdYZeA1wQl3udY9C7FkLQNGbM03PqemI00PKAsISyn');
    ...
    <div className='px-6'>
      {cart.length >= 1 ? (
        <div className='flex justify-between gap-x-4'>
          ...
          <button onClick={handlePayment} className='btn btn-accent hover:bg-accent text-primary flex-1 px-2 gap-x-2'>Checkout<IoArrowForward className='text-lg' /></button>
        </div>
      ) : (
